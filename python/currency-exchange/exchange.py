...
def non_exchangeable_value(
    ...
    _budget_exchanged = exchange_money(budget, exchange_rate * (1 + spread / 100))
    _exchangeable_value = exchangeable_value(
        budget, exchange_rate, spread, denomination
    )
    return int(_budget_exchanged - _exchangeable_value)
